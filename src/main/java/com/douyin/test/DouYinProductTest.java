...
public class DouYinProductTest {
    public String dy(String accessToken, String apiKey) {
        HttpClient httpClient = HttpClientBuilder.create().build();
        String url = "http://bhtsp.dongmingwangluo.com/api/data?apiKey=" + apiKey;

        // 准备接口参数
        JSONObject paramJson = new JSONObject();
//        paramJson.put("size", 20);
//        paramJson.put("page", 0);

        paramJson.put("outer_product_id", "232334");//是否必须:否；示例值：232334；参数描述：推荐使用，外部商家编码，支持字符串。超市小时达场景不推荐使用
        paramJson.put("product_type", 0);//是否必须:是；示例值：0；参数描述：0-普通，3-虚拟，6玉石闪购，7云闪购
        paramJson.put("category_leaf_id", 20000);//是否必须:是；示例值：20000；参数描述：叶子类目ID通过/shop/getShopCategory接口获取
        ...
        paramJson.put("name", "xxx补水液");//是否必须:是；示例值：xxx补水液；参数描述：商品名称，最多60个字符(30个汉字)，不能含emoj表情
        paramJson.put("recommend_remark", "这个商品很好啊");//是否必须:否；示例值：这个商品很好啊；参数描述：商家推荐语，不能含emoj表情
        paramJson.put("pic", "img_url1|img_url2|img_url3");//是否必须:是；示例值：img_url1|img_url2|img_url3；参数描述：商品轮播图，多张图片用 \"|\" 分开，第一张图为主图，最多5张，至少600x600，大小不超过1M。
        paramJson.put("description", "img_url1|img_url2|img_url3");//是否必须:是；示例值：img_url1|img_url2|img_url3；参数描述：商品描述，目前只支持图片。多张图片用 \"|\" 分开。不能用其他网站的文本粘贴，这样会出现css样式不兼容。总图片数量不得超过50张。
        ...
        paramJson.put("assoc_ids", "1|2|3");//是否必须:否；示例值：1|2|3；参数描述：同店商品推荐：为空表示使用系统推荐；多个product_id使用“|”分开
...
//        paramJson.put("presell_end_time","2020-02-21 18:54:27");//是否必须:否；示例值：1；参数描述：预售结束时间，格式2020-02-21 18:54:27，最多支持设置距离当前30天
        ...
        paramJson.put("mobile", "40012345");//是否必须:是；示例值：40012345；参数描述：客服电话号码
        paramJson.put("commit", false);//是否必须:是；示例值：true；参数描述：false仅保存，true保存+提审
        paramJson.put("out_product_id", 123);//是否必须:否；示例值：1；参数描述：外部product_id。超市小时达场景不推荐使用
        paramJson.put("remark", "备注");//是否必须:否；示例值：备注；参数描述：商家可见备注
        paramJson.put("spec_name", "颜色-尺码");//是否必须:否；示例值：颜色-尺码；参数描述：如果不填，则规格名为各级规格名用 \"-\" 自动生成
        paramJson.put("specs", "颜色|红色,黑色^尺码|S,M");//是否必须:否；示例值："颜色|红色,黑色^尺码|S,M"；参数描述：店铺通用规格，能被同类商品通用。多规格用^分隔，规格与规格值用|分隔，多个规格值用,分隔。如果创建或编辑现货+预售商品或新预售商品时，须包含发货时效，如：颜色|黑色,白色,黄色^尺码|S,M,L^发货时效|5天内发货,15天内发货
        /*
         *是否必须:是；
         ...
         */
        paramJson.put("spec_prices", "[{\\\"spec_detail_name1\\\":\\\"红色\\\",\\\"spec_detail_name2\\\":\\\"S\\\",\\\"spec_detail_name3\\\":\\\"\\\",\\\"stock_num\\\":11,\\\"price\\\":100,\\\"code\\\":\\\"\\\",\\\"step_stock_num\\\":0,\\\"supplier_id\\\":\\\"\\\",\\\"outer_sku_id\\\":\\\"\\\",\\\"delivery_infos\\\":[{\\\"info_type\\\":\\\"weight\\\",\\\"info_value\\\":\\\"100\\\",\\\"info_unit\\\":\\\"mg\\\"}]},{\\\"spec_detail_name1\\\":\\\"红色\\\",\\\"spec_detail_name2\\\":\\\"M\\\",\\\"spec_detail_name3\\\":\\\"\\\",\\\"stock_num\\\":22,\\\"price\\\":100,\\\"code\\\":\\\"\\\",\\\"step_stock_num\\\":0,\\\"supplier_id\\\":\\\"\\\",\\\"outer_sku_id\\\":\\\"\\\",\\\"delivery_infos\\\":[{\\\"info_type\\\":\\\"weight\\\",\\\"info_value\\\":\\\"100\\\",\\\"info_unit\\\":\\\"mg\\\"}]},{\\\"spec_detail_name1\\\":\\\"黑色\\\",\\\"spec_detail_name2\\\":\\\"S\\\",\\\"spec_detail_name3\\\":\\\"\\\",\\\"stock_num\\\":44,\\\"price\\\":100,\\\"code\\\":\\\"\\\",\\\"step_stock_num\\\":0,\\\"supplier_id\\\":\\\"\\\",\\\"outer_sku_id\\\":\\\"\\\",\\\"delivery_infos\\\":[{\\\"info_type\\\":\\\"weight\\\",\\\"info_value\\\":\\\"100\\\",\\\"info_unit\\\":\\\"mg\\\"}]},{\\\"spec_detail_name1\\\":\\\"黑色\\\",\\\"spec_detail_name2\\\":\\\"M\\\",\\\"spec_detail_name3\\\":\\\"\\\",\\\"stock_num\\\":55,\\\"price\\\":100,\\\"code\\\":\\\"\\\",\\\"step_stock_num\\\":0,\\\"supplier_id\\\":\\\"\\\",\\\"outer_sku_id\\\":\\\"\\\",\\\"delivery_infos\\\":[{\\\"info_type\\\":\\\"weight\\\",\\\"info_value\\\":\\\"100\\\",\\\"info_unit\\\":\\\"mg\\\"}]}]");
        paramJson.put("spec_pic", "img_url,img_url,img_url");//是否必须:否；示例值：img_url,img_url,img_url；参数描述：如颜色-尺寸, 颜色就是主规格, 颜色如黑,白,黄,它们图片url以逗号分隔 注：\"pic\"、\"description\"、\"spec_pic\"这三个字段里的传入的图片数量总和，不得超过50张。
...
//        paramJson.put("product_format_new","{\\\"405\\\":[{\\\"value\\\":27664,\\\"name\\\":\\\"复习资料\\\",\\\"diy_type\\\":0}],\\\"449\\\":[{\\\"value\\\":0,\\\"name\\\":\\\"佚名\\\",\\\"diy_type\\\":0}],\\\"501\\\":[{\\\"value\\\":7310,\\\"name\\\":\\\"否\\\",\\\"diy_type\\\":0}],\\\"855\\\":[{\\\"value\\\":61683,\\\"name\\\":\\\"北京出版社\\\",\\\"diy_type\\\":0}],\\\"1088\\\":[{\\\"value\\\":407,\\\"name\\\":\\\"小学五年级\\\",\\\"diy_type\\\":0}],\\\"1319\\\":[{\\\"value\\\":0,\\\"name\\\":\\\"1\\\",\\\"diy_type\\\":0}],\\\"1601\\\":[{\\\"value\\\":13911,\\\"name\\\":\\\"通用版\\\",\\\"diy_type\\\":0}],\\\"1618\\\":[{\\\"value\\\":0,\\\"name\\\":\\\"9787218122861\\\",\\\"diy_type\\\":0}],\\\"1831\\\":[{\\\"value\\\":0,\\\"name\\\":\\\"小学英语看图说话写话二年级\\\",\\\"diy_type\\\":0}],\\\"2000\\\":[{\\\"value\\\":34762,\\\"name\\\":\\\"无\\\",\\\"diy_type\\\":0}],\\\"2229\\\":[{\\\"value\\\":0,\\\"name\\\":\\\"1\\\",\\\"diy_type\\\":0}],\\\"2763\\\":[{\\\"value\\\":25193,\\\"name\\\":\\\"英语\\\",\\\"diy_type\\\":0}],\\\"3271\\\":[{\\\"value\\\":0,\\\"name\\\":\\\"1\\\",\\\"diy_type\\\":0}],\\\"3296\\\":[{\\\"value\\\":0,\\\"name\\\":\\\"16.80元\\\",\\\"diy_type\\\":0}]}");//是否必须:否；示例值：；参数描述：属性，通过/product/getCatePropertyV2获取 格式：{"property_id":[{"value":value,"name":"property_name","diy_type":0}]} name的类型是string，value和diy_type的类型是number
//        paramJson.put("spu_id", 14567);//是否必须:否；示例值：14567；参数描述：spu_id
//        paramJson.put("appoint_delivery_day", 2);//是否必须:否；示例值：2；参数描述：可预约发货天数
        paramJson.put("third_url", "http://img.alicdn.com/xxxx");//是否必须:否；示例值：http://img.alicdn.com/xxxx；参数描述：third_url
        paramJson.put("extra", "略");//是否必须:否；示例值：略；参数描述：extra
        paramJson.put("src", "略");//是否必须:否；示例值：略；参数描述：src
...
//        paramJson.put("after_sale_service","{ 'supply_day_return_selector':'7-2' }");//是否必须:否；示例值：1；参数描述：推荐传入，售后服务参数,key:value格式。supply_day_return_selector(7天无理由选项)：N天-政策代号，N只支持7和15，政策代号枚举https://bytedance.feishu.cn/docs/doccnF946oh1c98e7mo9DlYZtig 。 supply_red_ass_return（红屁屁无忧）：0不支持，1支持。supply_allergy_return（过敏无忧,仅跨境可选）：0不支持，1支持。 damaged_order_return（坏损包退）：0不支持，1支持。 support_allergy_returnV2（过敏包退，境内可选）：0不支持，1支持
        ...
        paramJson.put("start_sale_type", 1);//是否必须:否；示例值：1；参数描述：审核通过后上架售卖时间配置:0-立即上架售卖 1-放入仓库
//        paramJson.put("material_video_id","vaaaa");//是否必须:否；示例值："vaaaa"；参数描述：主图视频ID，可以先通过https://op.jinritemai.com/docs/api-docs/69/1617接口上传视频，获取审核通过的视频素材ID进行传入 任务需要验证
        ...
        paramJson.put("size_info_template_id", 101);//是否必须:否；示例值：101；参数描述：尺码模板ID
        paramJson.put("substitute_goods_url","https://xxx.xxx.xxx");//是否必须:否；示例值：https://xxx.xxx.xxx；参数描述：外部商品url
        paramJson.put("sale_channel_type", "sameAsOffline");//是否必须:否；示例值：sameAsOffline；参数描述：销售渠道类型，可选onlineOnly（纯电商，仅在线上售卖）或sameAsOffline（专柜同款，线上线下都有售卖），云零售商家（https://fxg.jinritemai.com/ffa/merchant-growth/cloud-retail）可以设置
        paramJson.put("store_id", 12345);//是否必须:否；示例值：12345；参数描述：门店ID
...
//        paramJson.put("is_auto_charge",false);//是否必须:否；示例值：false；参数描述：是否是自动充值商品
    ...
    public static void main(String[] args) {
        ...
        DouYinProductTest example = new DouYinProductTest();
        String response = example.dy(accessToken, apiKey);
